...
export default function EditAddress({ region, address, isActive = false, }: EditAddressProps) {
        ...
        <>
            ...
            >
                <div className="flex flex-col">
                    <h1 className="text-left text-base-semi" data-testid="address-name">
                        {address.first_name} {address.last_name}
                    </h1>
                    {address.company && (
                        <span className="txt-compact-small text-ui-fg-base" data-testid="address-company">
                            {address.company}
                        </span>
                    )}
                    <span className="flex flex-col text-left text-base-regular mt-2">
